...
import static com.zentra.zentragate.constants.Constants.IMDB_ID_SEARCH_URL_FORMAT;
...
public class MediaRepositoryImpl implements MediaRepository {
    ...
    @Autowired
    public MediaRepositoryImpl(TMDBConfig tmdbConfig) {
    ...
    public MediaDetail getMediaDetailsByImdbId(String imdbId) throws MediaNotFoundException {
        String searchUrl = String.format(IMDB_ID_SEARCH_URL_FORMAT,
    ...
    void setTVMediaContent(TMDBResponse tmdbResponse, MediaDetail mediaDetails) {
    ...
    void setMovieMediaContent(TMDBResponse tmdbResponse, MediaDetail mediaDetails) {
